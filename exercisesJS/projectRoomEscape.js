...
var shelf = new RoomObject('Shelf', 'It has a flashlight', ['flashlight','batteries','pencil'], ['flashlight','batteries'], 'check')
var cupboard = new RoomObject('Cupboard', 'It does not have anything useful', ['mug','cereal'], ['false'], 'open') 
var drawer = new RoomObject('Drawer','It has a key that opens the room', ['peeler', 'lemon squeezer', 'key'], ['key'], 'open')

var RoomObjects = [shelf, cupboard, drawer]

// Create an array of Room objects
var kitchen = new Room(RoomObjects)
var Room = [kitchen]

// Create a new Game

// Create a new Player
var player = new Player(kitchen)
