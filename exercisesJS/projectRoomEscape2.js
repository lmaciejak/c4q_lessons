...
var shelf = new RoomObject('shelf', 'There is a key', ['key'], [], 'check')
var cupboard = new RoomObject('cupboard', 'It has a flashlight', ['flashlight'], ['key'], 'open') 
var drawer = new RoomObject('drawer','The drawer is dark', ['passcode'], ['flashlight'], 'open')
var door = new RoomObject('door', 'The door is locked', [], ['passcode'], 'open')

var RoomObjects = [shelf, cupboard, drawer, door]

// Create an array of Room objects
var kitchen = new Room(RoomObjects)
var rooms = [RoomObjects] 

// Create a new Game
var game = new Game([kitchen])
